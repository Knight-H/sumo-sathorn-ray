...
def main():
    ...
    parser.add_argument('-A', '--algorithm', action='store', nargs=1, default='DQN', type=str,
    ...
    parser.add_argument('-T', '--annealTimeStep', action='store', nargs=1, default='100k', type=str,
    ...
    parser.add_argument('-d', '--double', action='store_true',
                        help='Double DQN')
    parser.add_argument('-u', '--updateFreq', action='store', nargs=1, default=800, type=int,
                        help='Network update frequency')
    parser.add_argument('-B', '--buffer', action='store', nargs=1, default='100k', type=str,
    ...
    parser.add_argument('-i', '--trainIter', action='store', nargs=1, default=100000, type=int,
                        help='Training Iteration')
    parser.add_argument('-c', '--checkFreq', action='store', nargs=1, default=5, type=int,
